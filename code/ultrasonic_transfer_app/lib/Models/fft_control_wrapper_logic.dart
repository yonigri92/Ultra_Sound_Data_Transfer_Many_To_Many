...
enum ControlAction {
  ...
  respondWithBusy,
  swallowControlNoise,
  externalDiscoveryOverheard          // i head discovery but im busy so sound the busy horn and continue data transfer
}
...
class FftControlWrapperLogic {
  ...
  final double _busyFreq = 20800.0;
  final double _discoveryFreq = 20400.0;
  ...
  ControlAction processAudioWindow({
    ...
    if (isSessionLocked && discoveryEnergy > 0.2) {
      return ControlAction.externalDiscoveryOverheard;
    }
